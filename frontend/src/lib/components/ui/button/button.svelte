	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				destructive:
					'bg-destructive/30 text-destructive/80 border-1 border-destructive/80 shadow-xs hover:bg-destructive/40 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/10',
				outline:
